...
static void materializeSPPlusOffset(MachineInstr &MI,
...
bool LinxISARegisterInfo::eliminateFrameIndex(MachineBasicBlock::iterator II,
  ...
  case LinxISA::SD: {
    ...
    materializeSPPlusOffset(MI, II, TII, BaseReg, OffsetBytes);
  ...
  if (UnsignedImm ? !isUInt<12>(ScaledOff) : !isInt<12>(ScaledOff)) {
    ...
    materializeSPPlusOffset(MI, II, TII, BaseReg,

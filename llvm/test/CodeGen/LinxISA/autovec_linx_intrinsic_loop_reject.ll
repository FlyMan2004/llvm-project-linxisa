...
entry:
  %seed = call %linx.tile @llvm.linx.tile.tload(ptr %a, i32 8, i32 1, i64 0, i64 8, i64 8, i64 0)
  br label %loop

loop:                                             ; preds = %loop, %entry
  %i = phi i32 [ 0, %entry ], [ %i.next, %loop ]
  %acc = phi %linx.tile [ %seed, %entry ], [ %acc.next, %loop ]
  %acc.next = call %linx.tile @llvm.linx.tepl.binary(%linx.tile %acc, %linx.tile %seed, i32 0, i32 8, i32 1)
...
exit:                                             ; preds = %loop
  ...
  call void @llvm.linx.tile.tstore(ptr %dst, %linx.tile %outv, i32 8, i32 1, i64 0, i64 8, i64 8, i64 0)
  ret void
}

...
; CHECK-NOT: BSTART
; CHECK: FENTRY
; CHECK: BSTART{{[[:space:]]+}}CALL, baz_leaf, ra=[[CR_RET:\.LBB[0-9_]+]]
; CHECK-NOT: c.setret
; CHECK: [[CR_RET]]:
; CHECK-NOT: BSTART
; CHECK: FRET.STK
...
; CHECK-NOT: BSTART
; CHECK: FENTRY
; CHECK: BSTART{{[[:space:]]+}}CALL, baz_leaf, ra=[[BAR_RET:\.LBB[0-9_]+]]
; CHECK-NOT: c.setret
; CHECK: [[BAR_RET]]:
; CHECK: FRET.STK
; CHECK-NOT: C.BSTOP
...
; CHECK-NOT: BSTART
; CHECK: FENTRY
; CHECK: BSTART{{[[:space:]]+}}CALL, bar, ra=[[FOO_RET1:\.LBB[0-9_]+]]
; CHECK-NOT: c.setret
; CHECK: [[FOO_RET1]]:
; CHECK: BSTART{{[[:space:]]+}}CALL, baz_leaf, ra=[[FOO_RET2:\.LBB[0-9_]+]]
; CHECK-NOT: c.setret
; CHECK: [[FOO_RET2]]:
; CHECK: FRET.STK
; CHECK-NOT: C.BSTOP

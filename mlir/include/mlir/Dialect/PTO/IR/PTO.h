...
#include "mlir/Dialect/PTO/IR/PTODialect.h"

//===----------------------------------------------------------------------===//
// PTO Enums
//===----------------------------------------------------------------------===//

#include "mlir/Dialect/PTO/IR/PTOEnums.h.inc"

//===----------------------------------------------------------------------===//
// PTO Interfaces
//===----------------------------------------------------------------------===//

#include "mlir/Dialect/PTO/IR/PTOInterfaces.h.inc"
...
#include "mlir/Dialect/PTO/IR/PTOAttrs.h.inc"
...
#include "mlir/Dialect/PTO/IR/PTOTypeDefs.h.inc"
...
#include "mlir/Dialect/PTO/IR/PTOOps.h.inc"
